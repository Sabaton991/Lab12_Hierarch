...
{
ShowMessage("Это проект, который реализует движение обьектов по осям и вокруг собственных осей, скорость вращения можно регулировать самостоятельно с помощью ползунка");
}
//---------------------------------------------------------------------------
